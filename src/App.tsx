                ...
                if (subscription) {
                    ...
                    registration.pushManager
                        .subscribe({
                            ...
                            applicationServerKey: "BJnQL_vKmedasnhbav9oj4BvVoOVczMEgv36LodBmRp_bYe_6yBG1UUKEDIC-G5RANqyaiSZv0zrH0UELVyApx4",
                        })
                        .then((subscription) => {
                            // save subscription to server
                        });
            ...
            <Box textAlign="center" fontSize="xl">
                <Grid minH="100vh" p={3}>
                    ...
                    <VStack spacing={8}>
                        <Card>
                            <CardHeader>
                                ...
                                <Text pt="2" fontSize="sm">
                                    웹 더치페이 (각자내기, N빵) 계산기입니다. 한 명만 결제했을 때뿐만 아니라, 다수가 한 번에 결제했을 경우에도 계산할 수
                                    있습니다.
                                </Text>
                                <Text fontSize="sm" pt="2" as="i">
                                    아이폰/안드로이드에서 '홈 화면에 추가' 혹은 '현재 페이지 추가' 버튼을 누르면 휴대폰에 더치페이 계산기 앱을 설치할 수
                                    있습니다.
                                </Text>
                            </CardHeader>
                            <CardBody>
                        ...
                        <Text pt="4" fontSize="sm" color={"GrayText"}>
                            ...
                            <Fade in={isOpen}>
                                <Box p="20px" mt="4" rounded="md" shadow="md">
                                    <Text fontSize="sm">
                                        (총 지불 금액) ÷ (총 인원 수) = 원래 내야하는 금액¹ 이라고 하면,
                                        <br />
                                        (원래 내야하는 금액) - (어떤 사람이 돈을 지불한 액수)²가 양수이면 원래 내야하는 금액보다 덜 낸 것이기 때문에 돈을
                                        뱉어내면 됩니다.
                                        <br />
                        ...
                        <Button size="xs" onClick={onSubscribe}>
                            구독하기
                        </Button>
                    </VStack>
                </Grid>
